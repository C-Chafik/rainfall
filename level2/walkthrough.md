...
We have the main func, and the p func.
...
Dump of assembler code for function p:
   ...
   0x08048532 <+94>:	lea    -0x4c(%ebp),%eaxhttps://docs.github.com/en/authentication/keeping-your-account-and-data-secure/removing-sensitive-data-from-a-repository
...
So the main function call the p function which make a gets we can use to make another buffer overflow.
